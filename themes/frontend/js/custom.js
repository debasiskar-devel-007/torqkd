...
function widthCal(id){
	//alert(id);
	var windowwidth=parseInt($(window).width());
    var modalwidth=parseInt($("#"+id).width()); 
    var extrawidth=parseInt(windowwidth-modalwidth);
    var extrawidth =parseInt(extrawidth/2);
    $("#"+id).css("left",extrawidth);
    //$("#"+id).modal("show");
